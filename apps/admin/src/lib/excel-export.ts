...
/**
 * Part O.2 / Part G: Export single doctor's bookings for a day as .xlsx
 */
...
/**
 * Part O.3 / Part G: Export all doctors' bookings for a day, grouped by doctor with styled sub-headers.
 */
