...
export const departments: Department[] = [
  ...
  },
  {
    ...
    shortDescription:
      "Specialized pain relief and medical care during surgical procedures.",
    overview:
      "Providing comprehensive perioperative care, pain management, and critical life support before, during, and after surgical interventions.",
    commonTreatments: [
      "General Anaesthesia",
  ...
  },
  {
    ...
    name: "Oncology",
    shortDescription:
      "Comprehensive cancer diagnosis, staging, and treatment planning.",
    overview:
      "Dedicated to the early detection, specialized treatment, and ongoing management of various cancers using multidisciplinary approaches.",
    commonTreatments: [
